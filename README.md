...
5. Authentication text and pad are encrypted again to prevent attackers from decrypting it directly using the test text("Tada!!"). It is possible because SBET is malleable and resistant to chosen-cipher text attack at the same time(again, if Russian Copulation stands true)
